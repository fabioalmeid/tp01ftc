...
import gramatica.Centralizador.VisitSkel.AcaoVisitor;

public class TransformIntoObject {
	
	public Object teste(Tarefa t){
		Object objeto = new Object();
		t.accept(new TarefaVisitor<String, String>(), null);
		return new Object();
	}
